  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      await NotificationModel.create({
        ...
        message: `You have recieved a Question in ${courseContent?.title}`,
      });
      await course?.save();
      res.status(200).json({
        success: true,
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const notification = {
        ...
        messge: `${req.user?.name} has given a review on your course ${course?.name}`,
      };
      //create notification
      res.status(200).json({
        success: true,
